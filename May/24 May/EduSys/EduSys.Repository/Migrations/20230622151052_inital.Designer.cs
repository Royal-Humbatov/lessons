...
namespace EduSys.Repository.Migrations
{
    ...
    [Migration("20230622151052_inital")]
            ...
            modelBuilder.Entity("EduSys.Core.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2023, 6, 22, 19, 10, 52, 751, DateTimeKind.Local).AddTicks(978),
                            Name = "Computer",
                            Price = 800m,
                            Stock = 35m
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2023, 6, 22, 19, 10, 52, 751, DateTimeKind.Local).AddTicks(988),
                            Name = "T-Shirt",
                            Price = 50m,
                            Stock = 400m
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2023, 6, 22, 19, 10, 52, 751, DateTimeKind.Local).AddTicks(989),
                            Name = "Cat food",
                            Price = 25m,
                            Stock = 1000m
                        });
