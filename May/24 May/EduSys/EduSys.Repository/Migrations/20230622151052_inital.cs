    ...
    public partial class inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedDate", "Name", "UpdatedData" },
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedData" },
                values: new object[] { 1, 1, new DateTime(2023, 6, 22, 19, 10, 52, 751, DateTimeKind.Local).AddTicks(978), "Computer", 800m, 35m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedData" },
                values: new object[] { 2, 2, new DateTime(2023, 6, 22, 19, 10, 52, 751, DateTimeKind.Local).AddTicks(988), "T-Shirt", 50m, 400m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdatedData" },
                values: new object[] { 3, 3, new DateTime(2023, 6, 22, 19, 10, 52, 751, DateTimeKind.Local).AddTicks(989), "Cat food", 25m, 1000m, null });

            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Color", "CreatedDate", "Height", "ProductId", "UpdatedData", "Width" },
